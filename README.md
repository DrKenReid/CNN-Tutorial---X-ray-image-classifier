...
2. You will need a [Kaggle API token](https://www.kaggle.com/settings/account) — create one under "API Tokens" in your account settings. The notebook walks you through setup and installs the required `kaggle` CLI (≥ 1.8.0).
